...
/**
  ...
  public ExitListener(String message, String title) {
...
/**
  ...
  public ExitListener(Action closeAction) {
...
/**
  ...
  public ExitListener(String message, String title, Action closeAction) {
